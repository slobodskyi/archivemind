...
export function HandToolIcon({ width = 16, height = 16, ...props }: IconProps) {
  // Pan → a pointing hand, tilted to match the reference: index finger up,
  // three knuckle bumps curled beside it, palm resting at the bottom with
  // two crease marks. The previous pass hand-tuned the curled fingers into
  // full-length rects, which read as a "peace sign" rather than curled
  // knuckles — this instead rotates the known-good upright shape (its own
  // curves untouched) rather than re-deriving new bezier coordinates.
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" {...props}>

...
/** A capital "A" — the note tools' "type" (text) mode toggle. */
...
/** A capital "B" — bold. Drawn, not a glyph, so it matches the stroke weight of
 *  every other icon on the strip. */
...
/** A serif "T" for the title/heading style. */

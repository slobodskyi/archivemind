...
grid) superseded by [0022](0022-timeline-clouds-and-live-cloud-labels.md), then
[0024](0024-timeline-date-axis-cloud-focus.md); Topic's grouping field by
[0023](0023-topic-clouds-derived-from-tags.md) — read 0022 + 0023 + 0024 for what ships
today.** What survives from here: Timeline buckets on the **real capture date** — though at
*day* granularity now (0024), not this ADR's months.
